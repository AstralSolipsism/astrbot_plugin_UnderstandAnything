  ...
  return (
    <div className="h-full w-full overflow-auto p-5 animate-fade-slide-in">
              ...
              return (
                <div key={type}>
                  <div className="flex items-center justify-between text-xs mb-1">
                    <span className="text-text-secondary">{nodeTypeLabel(type)}</span>
      ...
      <div className="text-[11px] text-text-muted mb-6">
        {t.common.analyzed}: {new Date(project.analyzedAt).toLocaleDateString("zh-CN", { year: "numeric", month: "short", day: "numeric" })}
      </div>
