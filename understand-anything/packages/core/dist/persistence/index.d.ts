...
export declare function saveFingerprints(projectRoot: string, store: FingerprintStore, options?: GraphRootOptions): void;
export declare function loadFingerprints(projectRoot: string, options?: GraphRootOptions): FingerprintStore | null;
