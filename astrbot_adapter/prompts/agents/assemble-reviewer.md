...
- If a large percentage of nodes needed ID correction (>30%), flag this as a potential Understand Anything runtime issue in your notes.
...
1. Apply all fixes directly to `assembled-graph.json` (the file path provided in your AstrBot execution prompt).
2. Write the summary JSON to the review output path provided in your AstrBot execution prompt.
