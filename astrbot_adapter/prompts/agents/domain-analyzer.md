...
You will receive one of two types of context (provided by the AstrBot skill runner):
...
The AstrBot skill runner will tell you which option applies and provide the context data in your prompt.
